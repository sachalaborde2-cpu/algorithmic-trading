...
# Actions/ETF : point_value=100.0 pour 100 actions de reference (comme
# SPY/QQQ dans vwap_reversion/pairs_trading), tick=0.01 (marche actions US).
# Valeurs prudentes, a verifier sur la grille tarifaire IBKR.
_STOCK = Instrument(tick=0.01, point_value=100.0, commission_side=1.00)
INSTRUMENTS = {
    ...
    "IWM": _STOCK, "SOFI": _STOCK, "PLUG": _STOCK, "MARA": _STOCK,
    "RIOT": _STOCK, "AFRM": _STOCK, "UPST": _STOCK, "KRE": _STOCK,
}
