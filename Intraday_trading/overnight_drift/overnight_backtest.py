"""
Backtest de la derive "overnight vs intraday" sur indices US (MES, SPY, QQQ,
IWM).
...
Usage
-----
    python overnight_backtest.py data/MES_5min_all.csv --instrument MES
...
INSTRUMENTS = {
    ...
    # CSPX (iShares Core S&P 500 UCITS ETF, LSEETF/USD) : seance 09:00-17:50
    # heure de Paris (contrairement au NY 09:30-16:00 des autres lignes).
    "CSPX": Instrument(tick=0.0005, point_value=100.0, commission_side=1.00,
                        tz="Europe/Paris", session_start="09:00", session_minutes=530,
                        session_end="17:49"),
}
